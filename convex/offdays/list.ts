...
/**
 * Internal query to get all off days for a specific child's school within a date range.
 * Includes database-stored off days and automatically generated Wednesdays, Saturdays, and Sundays.
 * Used internally for price calculations.
 */
export const getOffDaysInRange = internalQuery({
  args: {
    childId: v.id("children"),
    startDate: v.string(), // YYYY-MM-DD
    endDate: v.string(), // YYYY-MM-DD
